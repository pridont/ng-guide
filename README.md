...
რენდერება (`util/mermaid.js`), ანუ mermaid-ის ბიბლიოთეკა ბრაუზერში არ
იტვირთება და დიაგრამები მუშაობს ჯავასკრიპტის გარეშეც და ბეჭდვისასაც.

თითოეული დიაგრამა ორჯერ რენდერება — ბნელი და ნათელი თემისთვის — და
გვერდზე ორივე ვარიანტი ხვდება; საიტი შესაბამის CSS აჩენს.
...
- თუ დიაგრამის სინტაქსი მცდარია, ბილდი ჩავარდება და ხარვეზიან ფაილზე მიგვითითებს.

### დიაგრამის დამატება ან შეცვლა

დარენდერებული SVG-ები `diagrams/` ფოლდერშია და **რეპოზიტორიაშივე ინახება**.
ეს აუცილებელია: საიტი Cloudflare-ზე ბილდდება, სადაც Chromium არ არსებობს,
ანუ დეპლოის ბილდს დიაგრამის დახატვა არ შეუძლია — მხოლოდ უკვე დახატულის
გამოყენება.
