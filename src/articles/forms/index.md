...
ანგულარში ფორმების აგებისა და შეყვანილი ინფორმაციის მოხელთების სამი
გზა არსებობს: [Signal Forms](./signal-forms.html), template-driven და reactive.
Signal Forms ყველაზე ახალია (22-ე ვერსიიდან) და ახალ პროექტებში სწორედ ის
უნდა ვირჩიოთ. ქვემოთ აღწერილი ორი მიდგომა კი უამრავ არსებულ პროექტშია
გამოყენებული, ამიტომ მათი ცოდნაც აუცილებელია. ორივე მეთოდით შესაძლებელია
