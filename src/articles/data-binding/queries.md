...
[`input()` და `output()`](./input-output.html) მშობელსა და შვილს შორის
კომუნიკაციის სტანდარტული გზაა და უმეტეს შემთხვევაში სწორედ ისინი უნდა
გამოვიყენოთ.

ზოგჯერ კი მშობელ კომპონენტს **უშუალოდ შვილის ინსტანციაზე** სჭირდება
...
ერთი შედეგისთვის `contentChild` არსებობს, ზუსტად `viewChild`-ის მსგავსად.

**მნიშვნელოვანი ნაგულისხმევი:** `contentChildren` მხოლოდ **პირდაპირ**
...
ეს განზრახაა: სხვა შემთხვევაში კომპონენტები ერთმანეთის შიდა აგებულებაზე
...
გარეშე. თუ ელემენტი ვერ მოიძებნა, ანგულარი ერორს დააგდებს.
...
ალტერნატიულად, თემფლეითის ცვლადის სახელიც შეიძლება — მაშინ სტრინგს ვწერთ:
...
ნაგულისხმევად locator ორ რამეს განსაზღვრავს: *რომელ* ელემენტს ვეძებთ და
*რას* ვიღებთ მისგან. `read` ოფციით მეორე ნაწილის შეცვლა შეგვიძლია:
...
`output()`-ით იხსნება, ისინი უნდა ვირჩიოთ — ისინი კომპონენტებს შორის
კავშირს გაცილებით სუსტს ხდიან.
