...
`.component`, `.service`, `.directive` და მსგავსი სუფიქსები აღარ მოსდევს.
მთავარი კომპონენტის ფაილია `app.ts` და მასში ექსპორტირებული კლასი -
`App`. ძველ პროექტებსა და ძველ სახელმძღვანელოებში იმავე ფაილს
