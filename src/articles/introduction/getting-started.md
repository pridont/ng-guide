...
- `package-lock.json` - პროექტში დაინსტალირებული ყველა პაკეტისა და ქვედამოკიდებულების ზუსტ, ჩაკეტილ ვერსიას და მათ [ჰეშებს](https://en.wikipedia.org/wiki/Hash_function)
